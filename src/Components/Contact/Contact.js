      ...
      <S.ContainerForm>
        ...
        <S.TextEnviado >El formulario ha sido enviado</S.TextEnviado>
          ...
          <S.Form onSubmit={onSubmit} ref={form}>
            <S.InputForm placeholder='Tu nombre' type='text'name='name' onChange={(e) => setContactDates({...contactDates, name: e.target.value}) } 
            value={contactDates.name}
            />

            <S.InputForm placeholder='Tu correo electronico' type='email'name='email'onChange={(e) => setContactDates({...contactDates, email: e.target.value}) }
            value={contactDates.email}
            />

            <S.TextArea placeholder='Mensaje'name='message'onChange={(e) => setContactDates({...contactDates, message: e.target.value}) }
       ...
       {emptyInputs && (
        <S.TextError>POor favor complete los campos.</S.TextError>
   )}
